 ...
 * and where the recovery copies live too. A failure to *read* the database then
 * becomes a permanent loss, by the user's own hand, with the app never having
 * said a word.
 *
      ...
      <Paper elevation={2} sx={{ p: 3, maxWidth: 560, width: '100%' }}>
        <Stack spacing={2}>
          ...
          <Alert severity="error" icon={false}>
            ...
            cache or history deletes them — along with the recovery copies kept for exactly this
            kind of problem. Nothing has been lost yet.
          </Alert>
