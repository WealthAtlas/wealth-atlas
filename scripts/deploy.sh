...
echo "   echo \"NEXT_PUBLIC_API_URL=$BACKEND_URL/graphql\" > apps/frontend/.env.production"
echo "   # Build using pnpm workspaces"
echo "   pnpm run build:frontend"
echo "   aws s3 sync ./apps/frontend/out/ s3://$S3_BUCKET/ --delete"
echo ""
